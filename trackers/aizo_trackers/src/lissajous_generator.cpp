...
void LissajousGenerator::setParams(const aizo_tracker_msgs::LissajousTrackerGoal::ConstPtr &msg)
{
  x_amp_ = msg->x_amp;
  y_amp_ = msg->y_amp;
  z_amp_ = msg->z_amp;
...
void LissajousGenerator::setParams(const aizo_tracker_msgs::LissajousAdderGoal::ConstPtr &msg, int num)
{
...
const aizo_planning_msgs::PositionCommand::Ptr LissajousGenerator::getPositionCmd(void)
{
  if(!active_)
  {
...
{
  return goal_reached_ ? aizo_tracker_msgs::TrackerStatus::SUCCEEDED : aizo_tracker_msgs::TrackerStatus::ACTIVE;
}
