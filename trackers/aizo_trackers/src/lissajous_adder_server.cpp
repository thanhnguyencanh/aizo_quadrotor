...
#include <aizo_trackers/initial_conditions.h>
#include <aizo_trackers/lissajous_generator.h>
...
class LissajousAdder : public aizo_trackers_manager::Tracker
{
 public:
  LissajousAdder(void);
 ...
 private:
  ...
  typedef actionlib::SimpleActionServer<aizo_tracker_msgs::LissajousAdderAction> ServerType;
...
bool LissajousAdder::Activate(const aizo_planning_msgs::PositionCommand::ConstPtr &cmd)
{
...
aizo_planning_msgs::PositionCommand::ConstPtr LissajousAdder::update(const nav_msgs::Odometry::ConstPtr &msg)
{
  ...
  // Set gains
  aizo_planning_msgs::PositionCommand::Ptr cmd1 = generator_1_.getPositionCmd();
  aizo_planning_msgs::PositionCommand::Ptr cmd2 = generator_2_.getPositionCmd();
  ...
  else
  {
    ...
    {
      aizo_tracker_msgs::LissajousAdderFeedback feedback;
    ...
    {
      aizo_tracker_msgs::LissajousAdderResult result;
...
{
  return tracker_server_->isActive() ? static_cast<uint8_t>(aizo_tracker_msgs::TrackerStatus::ACTIVE) :
                                       static_cast<uint8_t>(aizo_tracker_msgs::TrackerStatus::SUCCEEDED);
}
...
void LissajousAdder::goal_callback(void)
{
  ...
  aizo_tracker_msgs::LissajousAdderGoal::ConstPtr msg = tracker_server_->acceptNewGoal();
...
PLUGINLIB_EXPORT_CLASS(LissajousAdder, aizo_trackers_manager::Tracker);
