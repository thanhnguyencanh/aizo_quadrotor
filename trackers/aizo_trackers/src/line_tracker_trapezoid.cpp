...
#include <aizo_planning_msgs/LineTrackerGoal.h>
...
class LineTrackerTrapezoid : public aizo_trackers_manager::Tracker
{
 public:
 ...
 private:
  void goal_callback(const aizo_planning_msgs::LineTrackerGoal::ConstPtr &msg);
...
bool LineTrackerTrapezoid::Activate(const aizo_planning_msgs::PositionCommand::ConstPtr &cmd)
{
...
aizo_planning_msgs::PositionCommand::ConstPtr LineTrackerTrapezoid::update(const nav_msgs::Odometry::ConstPtr &msg)
{
...
void LineTrackerTrapezoid::goal_callback(const aizo_planning_msgs::LineTrackerGoal::ConstPtr &msg)
{
  goal_(0) = msg->x;
  goal_(1) = msg->y;
  goal_(2) = msg->z;
...
PLUGINLIB_EXPORT_CLASS(LineTrackerTrapezoid, aizo_trackers_manager::Tracker);
