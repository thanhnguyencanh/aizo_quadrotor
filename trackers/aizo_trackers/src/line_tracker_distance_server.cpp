...
class LineTrackerDistance : public aizo_trackers_manager::Tracker
{
 public:
 ...
 private:
  ...
  typedef actionlib::SimpleActionServer<aizo_tracker_msgs::LineTrackerAction> ServerType;
...
bool LineTrackerDistance::Activate(const aizo_planning_msgs::PositionCommand::ConstPtr &cmd)
{
...
aizo_planning_msgs::PositionCommand::ConstPtr LineTrackerDistance::update(const nav_msgs::Odometry::ConstPtr &msg)
{
  ...
  aizo_planning_msgs::PositionCommand::Ptr cmd(new aizo_planning_msgs::PositionCommand);
  ...
  if((pos_ - goal_).norm() <= epsilon_)  // Reached goal
  {
    ...
    aizo_tracker_msgs::LineTrackerResult result;
  ...
  if(!goal_reached_)
  {
    aizo_tracker_msgs::LineTrackerFeedback feedback;
...
PLUGINLIB_EXPORT_CLASS(LineTrackerDistance, aizo_trackers_manager::Tracker);
