...
#include <aizo_tracker_msgs/LineTrackerGoal.h>
...
class LineTrackerYaw : public aizo_trackers_manager::Tracker
{
 public:
  LineTrackerYaw(void);
 ...
 private:
  void goal_callback(const aizo_tracker_msgs::LineTrackerGoal::ConstPtr &msg);
...
bool LineTrackerYaw::Activate(const aizo_tracker_msgs::PositionCommand::ConstPtr &cmd)
{
...
aizo_planning_msgs::PositionCommand::ConstPtr LineTrackerYaw::update(const nav_msgs::Odometry::ConstPtr &msg)
{
...
void LineTrackerYaw::goal_callback(const aizo_tracker_msgs::LineTrackerGoal::ConstPtr &msg)
{
  goal_pos_(0) = msg->x;
  goal_pos_(1) = msg->y;
  goal_pos_(2) = msg->z;
...
PLUGINLIB_EXPORT_CLASS(LineTrackerYaw, aizo_trackers_manager::Tracker);
