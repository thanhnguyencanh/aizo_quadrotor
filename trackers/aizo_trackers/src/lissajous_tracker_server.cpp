...
class LissajousTracker : public aizo_trackers_manager::Tracker
{
 public:
 ...
 private:
  ...
  typedef actionlib::SimpleActionServer<aizo_tracker_msgs::LissajousTrackerAction> ServerType;
...
bool LissajousTracker::Activate(const aizo_planning_msgs::PositionCommand::ConstPtr &cmd)
{
...
aizo_planning_msgs::PositionCommand::ConstPtr LissajousTracker::update(const nav_msgs::Odometry::ConstPtr &msg)
{
  ...
  // Set gains
  aizo_planning_msgs::PositionCommand::Ptr cmd = generator_.getPositionCmd();
  if(cmd == NULL)
  {
    return cmd;
  }
  else
  {
    ...
    {
      aizo_tracker_msgs::LissajousTrackerFeedback feedback;
    ...
    {
      aizo_tracker_msgs::LissajousTrackerResult result;
...
void LissajousTracker::goal_callback(void)
{
  ...
  aizo_tracker_msgs::LissajousTrackerGoal::ConstPtr msg = tracker_server_->acceptNewGoal();
...
PLUGINLIB_EXPORT_CLASS(LissajousTracker, aizo_trackers_manager::Tracker);
