...
class SmoothVelTracker : public aizo_trackers_manager::Tracker
{
 public:
 ...
 private:
  ...
  using ServerType = actionlib::SimpleActionServer<aizo_tracker_msgs::LineTrackerAction>;
...
bool SmoothVelTracker::Activate(const aizo_planning_msgs::PositionCommand::ConstPtr &cmd)
{
...
aizo_planning_msgs::PositionCommand::ConstPtr SmoothVelTracker::update(const nav_msgs::Odometry::ConstPtr &msg)
{
  if(!active_)
  {
...
{
  return goal_reached_ ? static_cast<uint8_t>(aizo_tracker_msgs::TrackerStatus::SUCCEEDED) :
                         static_cast<uint8_t>(aizo_tracker_msgs::TrackerStatus::ACTIVE);
}

#include <pluginlib/class_list_macros.h>
PLUGINLIB_EXPORT_CLASS(SmoothVelTracker, aizo_trackers_manager::Tracker);
