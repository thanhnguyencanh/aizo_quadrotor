...
#from aizo_tracker_msgs.msg import VelocityTrackerAction, VelocityTrackerGoal
from aizo_tracker_msgs.msg import VelocityGoal, TrackerStatus
...
class TwistToAction(object):
  ...
  def callback(self, data):
    ...
    if(self.current_tracker != "aizo_trackers/VelocityTracker"):
      ...
      try:
        ...
        resp1 = transition_tracker('aizo_trackers/VelocityTracker')
        print(resp1)
