...
namespace aizo_trackers_manager
{
class Tracker
{
 public:
   ...
   *
   * @param nh The NodeHandle with the aizo_trackers_manager's namespace, can be used to read common params such as gains.
   */
   ...
   */
  virtual bool Activate(const aizo_planning_msgs::PositionCommand::ConstPtr &cmd) = 0;

  /**
   * @brief Deactivate the tracker. This is called when the aizo_trackers_manager switches to another tracker.
   */
   ...
   */
  virtual aizo_planning_msgs::PositionCommand::ConstPtr update(const nav_msgs::Odometry::ConstPtr &msg) = 0;
