...
#include <aizo_planning_msgs/PositionCommand.h>
#include <aizo_planning_msgs/SO3Command.h>
#include <aizo_planning_msgs/TRPYCommand.h>
#include <aizo_tracker_msgs/CircleTrackerAction.h>
#include <aizo_tracker_msgs/LineTrackerAction.h>
#include <aizo_tracker_msgs/LissajousAdderAction.h>
#include <aizo_tracker_msgs/LissajousTrackerAction.h>
...
class MAVManager
{
 public:
  ...
  bool setPositionCommand(const aizo_planning_msgs::PositionCommand &cmd);
  bool setSO3Command(const aizo_planning_msgs::SO3Command &cmd);
  bool setTRPYCommand(const aizo_planning_msgs::TRPYCommand &cmd);
  bool useNullTracker();
 ...
 private:
  typedef actionlib::SimpleActionClient<aizo_tracker_msgs::LineTrackerAction> ClientType;
  typedef actionlib::SimpleActionClient<aizo_tracker_msgs::CircleTrackerAction> CircleClientType;
  typedef actionlib::SimpleActionClient<aizo_tracker_msgs::LissajousTrackerAction> LissajousClientType;
  typedef actionlib::SimpleActionClient<aizo_tracker_msgs::LissajousAdderAction> CompoundLissajousClientType;
  ...
  void output_data_cb(const aizo_planning_msgs::OutputData::ConstPtr &msg);
  void heartbeat_cb(const std_msgs::Empty::ConstPtr &msg);
  void tracker_status_cb(const aizo_tracker_msgs::TrackerStatus::ConstPtr &msg);
  void heartbeat();
