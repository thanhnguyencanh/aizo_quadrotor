...
#include <aizo_quadrotor_manager/Circle.h>
#include <aizo_quadrotor_manager/CompoundLissajous.h>
#include <aizo_quadrotor_manager/GoalTimed.h>
#include <aizo_quadrotor_manager/Lissajous.h>
#include <aizo_quadrotor_manager/Vec4.h>
...
class MAVManagerServices
{
 public:
  ...
  bool goTo_cb(aizo_quadrotor_manager::Vec4::Request &req, aizo_quadrotor_manager::Vec4::Response &res)
  {
  ...
  bool goToTimed_cb(aizo_quadrotor_manager::GoalTimed::Request &req, aizo_quadrotor_manager::GoalTimed::Response &res)
  {
  ...
  bool goToRelative_cb(aizo_quadrotor_manager::Vec4::Request &req, aizo_quadrotor_manager::Vec4::Response &res)
  {
  ...
  bool setDesVelInWorldFrame_cb(aizo_quadrotor_manager::Vec4::Request &req, aizo_quadrotor_manager::Vec4::Response &res)
  {
  ...
  bool setDesVelInBodyFrame_cb(aizo_quadrotor_manager::Vec4::Request &req, aizo_quadrotor_manager::Vec4::Response &res)
  {
  ...
  bool circle_cb(aizo_quadrotor_manager::Circle::Request &req, aizo_quadrotor_manager::Circle::Response &res)
  {
  ...
  bool lissajous_cb(aizo_quadrotor_manager::Lissajous::Request &req, aizo_quadrotor_manager::Lissajous::Response &res)
  {
  ...
  bool compound_lissajous_cb(aizo_quadrotor_manager::CompoundLissajous::Request &req,
                             aizo_quadrotor_manager::CompoundLissajous::Response &res)
  {
