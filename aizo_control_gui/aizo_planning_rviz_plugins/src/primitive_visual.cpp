...
#include <aizo_planning_rviz_plugins/primitive_visual.h>
#include <aizo_planning_rviz_plugins/trajectory_visual.h>
namespace kr {
...
void PrimitiveVisual::setMessage(
    const std::vector<aizo_planning_msgs::Primitive>& msgs) {
  poss_.clear();
  vels_.clear();
  accs_.clear();
  jrks_.clear();
  ...
  for (size_t n = 0; n < N; n++) {
    aizo_planning_msgs::Trajectory traj_viz_msg;
