...
#include <aizo_planning_msgs/SplineTrajectory.h>
#include <aizo_planning_rviz_plugins/spline_trajectory_visual.h>
...
class SplineTrajectoryDisplay
    : public rviz::MessageFilterDisplay<aizo_planning_msgs::SplineTrajectory> {
  Q_OBJECT
 public:
 ...
 private:
  void processMessage(const aizo_planning_msgs::SplineTrajectory::ConstPtr& msg);
  ...
  aizo_planning_msgs::SplineTrajectory trajectory_;
};
}  // namespace kr
