...
#include <aizo_planning_msgs/PrimitiveArray.h>
...
class PrimitiveArrayDisplay
    : public rviz::MessageFilterDisplay<aizo_planning_msgs::PrimitiveArray> {
  Q_OBJECT
 public:
 ...
 private:
  void processMessage(const aizo_planning_msgs::PrimitiveArray::ConstPtr& msg);
  ...
  aizo_planning_msgs::PrimitiveArray prs_msg_;
};
}  // namespace kr
