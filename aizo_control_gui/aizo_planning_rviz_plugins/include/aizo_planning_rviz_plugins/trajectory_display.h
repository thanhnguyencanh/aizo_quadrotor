...
class TrajectoryDisplay
    : public rviz::MessageFilterDisplay<aizo_planning_msgs::Trajectory> {
  Q_OBJECT
 public:
  TrajectoryDisplay();
 ...
 private:
  void processMessage(const aizo_planning_msgs::Trajectory::ConstPtr& msg);
  ...
  aizo_planning_msgs::Trajectory trajectory_;
};
}  // namespace kr
