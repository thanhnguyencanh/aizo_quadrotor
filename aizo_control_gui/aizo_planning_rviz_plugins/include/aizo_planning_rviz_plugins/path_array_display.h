...
class PathArrayDisplay
    : public rviz::MessageFilterDisplay<aizo_planning_msgs::PathArray> {
  Q_OBJECT
 public:
  PathArrayDisplay();
 ...
 private:
  void processMessage(const aizo_planning_msgs::PathArray::ConstPtr& msg);
  ...
  aizo_planning_msgs::PathArray paths_;
};
}  // namespace kr
