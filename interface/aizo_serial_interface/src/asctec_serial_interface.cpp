...
void encode_serial_msg(const aizo_planning_msgs::Serial &msg, std::vector<uint8_t> &serial_data)
{
...
void process_serial_data(const uint8_t *data, const size_t count, boost::function<void(aizo_planning_msgs::Serial &)> callback)
{
  static aizo_planning_msgs::Serial serial_msg;
