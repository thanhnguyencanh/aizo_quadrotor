...
#include <aizo_serial_interface/ASIOSerialDevice.h>
#include <aizo_serial_interface/serial_interface.h>
...
class QuadSerialComm : public nodelet::Nodelet
{
 ...
 private:
  ...
  void output_data_callback(aizo_planning_msgs::Serial &msg);
...
void QuadSerialComm::serial_callback(const aizo_planning_msgs::Serial::ConstPtr &msg)
{
...
void QuadSerialComm::output_data_callback(aizo_planning_msgs::Serial &msg)
{
...
void QuadSerialComm::onInit(void)
{
  ...
  output_data_pub_ = n.advertise<aizo_planning_msgs::Serial>("from_robot", 10);
