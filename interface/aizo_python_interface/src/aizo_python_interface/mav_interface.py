...
from aizo_tracker_msgs.msg import TrajectoryTrackerAction, TrajectoryTrackerGoal, CircleTrackerAction, CircleTrackerGoal, LineTrackerAction, LineTrackerGoal

from aizo_tracker_msgs.srv import Transition
from std_srvs.srv import Trigger, SetBool
from aizo_quadrotor_manager.srv import Vec4
...
class KrMavInterface(object):
  ...
  def transition_service_call(self, tracker_name):
    ...
    try:
      ...
      resp = tt('aizo_trackers/' + tracker_name)
      rospy.loginfo(resp)
