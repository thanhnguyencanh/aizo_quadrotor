...
void SO3TRPYControlNodelet::publishCommand()
{
  ...
  aizo_planning_msgs::TRPYCommand::Ptr trpy_command(new aizo_planning_msgs::TRPYCommand);
...
void SO3TRPYControlNodelet::position_cmd_callback(const aizo_planning_msgs::PositionCommand::ConstPtr &cmd)
{
...
void SO3TRPYControlNodelet::corrections_callback(const aizo_planning_msgs::Corrections::ConstPtr &msg)
{
...
void SO3TRPYControlNodelet::cfg_callback(aizo_quadrotor_controller::SO3Config &config, uint32_t level)
{
  if(level == 0)
  {
...
void SO3TRPYControlNodelet::onInit()
{
  ...
  trpy_command_pub_ = n.advertise<aizo_planning_msgs::TRPYCommand>("trpy_cmd", 10);
